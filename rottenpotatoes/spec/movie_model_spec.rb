...
describe Movie do
  ...
  context 'other movies by that director' do
    it 'finds movies with same director' do
      @movie_1 = Movie.create(:id => "210", title: "Other1", director: "Director")
      @movie_2 = Movie.create(:id => "215", title: "Other2", director: "Director")
  ...
  context 'no other movies by that director' do
    it 'finds no other movies with same director' do
      @movie_1 = Movie.create(:id => "555", title: "Other1", director: "Director")
      @movie_2 = Movie.create(:id => "666", title: "Other2", director: "Director2")
      results = Movie.similar_movies(@movie_1.id)
